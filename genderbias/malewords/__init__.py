...
MALE_WORDS = [word.strip() for word in open(_dir + "/Malewords.wordlist", 'r').readlines()]
...
class MaleDetector(Detector):
    ...
    def get_report(self, doc):
        ...
        if found:
            male_report.set_summary("Depending on context, these words may be biased towards recruiting men")
        return male_report
